...
const Roadmap = () => {
  ...
  let items = [
    ...
    {date: 'STO PRE', title: 'TODO', description: 'TREBA DA SE PROVERI ALLOWANCE PRE NEGO STO SE TRAZI DA SE POVECA KAD SE MINTUJE SA WETH TOKENOM'},
    {date: 'STO PRE', title: 'TODO', description: 'TREBA DA SE POPRAVI UPITNIK KOD WALTHROUGH-A'},
