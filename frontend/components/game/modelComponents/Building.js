...
export default function Building({ ...props }) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh castShadow geometry={nodes.GaragesQuad.geometry} material={materials['Material.004']} position={[21.68, 0.65, 35.01]} scale={[5.67, 0.75, 7.23]} />
      ...
      <mesh castShadow geometry={nodes.GaragesDouble.geometry} material={materials['Material.004']} position={[-29.03, 0.58, 18.6]} rotation={[0, -Math.PI / 2, 0]} scale={[5.67, 0.75, 7.23]} />
      ...
      <mesh castShadow geometry={nodes.Cone.geometry} material={materials['rock.002']} position={[44.55, -0.1, 27.41]} rotation={[0, -0.38, 0]} scale={0.75} />
      <mesh castShadow geometry={nodes.Cone001.geometry} material={materials['rock.002']} position={[34.7, -0.1, -10.89]} rotation={[Math.PI, -1.56, Math.PI]} scale={1.26} />
      <mesh castShadow geometry={nodes.Cylinder.geometry} material={materials['rock.001']} position={[53.98, -0.16, -36.79]} rotation={[0, -0.52, 0]} scale={1.33} />
      <mesh castShadow geometry={nodes.Cylinder001.geometry} material={materials['rock.001']} position={[-4.94, -0.9, -51.76]} rotation={[0.36, 0.23, 0]} scale={1.33} />
      <mesh castShadow geometry={nodes.Cylinder002.geometry} material={materials['rock.003']} position={[-41.49, -0.9, 52.65]} rotation={[0.35, -0.09, 0.12]} scale={1.33} />
    </group>
  )
}
