...
const Theme0 = ({level, reference, ...props}) => {
  const { nodes, materials } = useGLTF("/Factory Lvl 2.gltf");
  ...
  return (
    <group name="objectGroup" ref={reference} {...props} rotation={[0, Math.PI/2, 0]} scale={[scale, scale, scale]} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.vrata_garaza005.geometry}
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.vrata_garaza006.geometry}
        material={materials["garazna vrata"]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.vrata_garaza007.geometry}
        material={materials["garazna vrata"]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.vrata_garaza008.geometry}
        material={materials["garazna vrata"]}
      />
      <mesh
        castShadow
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.vrata_garaza009.geometry}
        material={materials["garazna vrata"]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.vrata_garaza010.geometry}
        material={materials["garazna vrata"]}
      />
      <mesh
        castShadow
...
useGLTF.preload("/Factory Lvl 2.gltf");
