...
const ParkSquare = forwardRef(function ParkSquare(props,ref) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <mesh castShadow receiveShadow geometry={nodes.Cylinder002.geometry} material={materials['rock.003']} position={[-10.24, -1.08, -17.27]} rotation={[0.44, 0.64, -0.19]} scale={1.78} />
      <mesh castShadow receiveShadow geometry={nodes.Cylinder003.geometry} material={materials['rock.003']} position={[-21.94, -0.09, -1.02]} rotation={[0, -0.08, 0]} scale={1.78} />
      <mesh castShadow receiveShadow geometry={nodes.Cone002.geometry} material={materials['rock.004']} position={[2.31, 0, 16.38]} rotation={[0, -1.14, 0]} scale={1.68} />
      <mesh castShadow receiveShadow geometry={nodes.Cone003.geometry} material={materials['rock.004']} position={[21.44, 0, 0.12]} rotation={[0, 0.06, 0]} />
    </group>
  )
})
