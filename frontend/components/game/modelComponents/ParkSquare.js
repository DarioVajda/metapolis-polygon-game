...
const ParkSquare = ({level, reference, ...props}) => {
  const { nodes, materials } = useGLTF('/ParkSquare.glb')
  return (
    <group name="objectGroup" ref={reference} {...props} scale={[props.scale[0], props.scale[1] * (level*2+1), props.scale[2]]}dispose={null}>
