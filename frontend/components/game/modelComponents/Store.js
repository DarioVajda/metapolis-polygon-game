...
const Store = forwardRef(function Store(props,ref) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <mesh castShadow receiveShadow geometry={nodes.Text.geometry} material={materials.Material} position={[-6, 15.6, 23]} rotation={[0, Math.PI / 2, 0]} scale={[15.15, 1, 15.15]} />
      <mesh castShadow receiveShadow geometry={nodes.Cone.geometry} material={materials['rock.002']} position={[23.04, 0, 8.22]} rotation={[0, -0.38, 0]} />
      <mesh castShadow receiveShadow geometry={nodes.Cone001.geometry} material={materials['rock.002']} position={[21.82, 0, 25.87]} rotation={[Math.PI, -1.56, Math.PI]} scale={1.68} />
      <mesh castShadow receiveShadow geometry={nodes.Cylinder.geometry} material={materials['rock.001']} position={[10.68, -0.09, -3.86]} rotation={[0, -0.52, 0]} scale={1.78} />
      <mesh castShadow receiveShadow geometry={nodes.Cylinder001.geometry} material={materials['rock.001']} position={[10.67, -1.08, 17.07]} rotation={[0.36, 0.23, 0]} scale={1.78} />
